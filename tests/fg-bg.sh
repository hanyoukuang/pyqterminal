#!/usr/bin/env bash
# Source: https://github.com/alacritty/alacritty/blob/master/scripts/fg-bg.sh
# License: Apache 2.0
# Tests: foreground/background color combinations with inverse, hidden, hidden+inverse
